    ...
    <main className="min-h-screen bg-black text-neutral-200 font-sans flex flex-col relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 relative z-10">
        <div className="max-w-md w-full border border-white/10 bg-neutral-900/20 backdrop-blur-md rounded-2xl p-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-white mb-2">Curriculum Loading</h1>
          <p className="text-neutral-500 mb-8 leading-relaxed">
            Departmental teaching materials and case studies are being uploaded to the secure server.
          </p>

          <div className="bg-neutral-950 rounded-lg p-4 mb-8 border border-neutral-800 font-mono text-xs text-left text-neutral-400">
             <p className="mb-1"><span className="text-emerald-500">➜</span> init_learning_module</p>
             <p className="mb-1">... user_auth_check [OK]</p>
             <p className="mb-1">... retrieving_slides [0/144]</p>
             <p className="text-purple-500">ℹ STATUS: CONTENT_PENDING</p>
          </div>
