...
export default function SummaryStep({
  ...
  // Compute anyYes / allAnswered from exposures
  ...
  // ---------- Amber pathway state (local to summary) ----------
  ...
  // ---------- Shared red chain state (local to summary) ----------
  ...
  // ---------- Post-malaria red activation (same behaviour) ----------
