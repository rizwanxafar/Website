...
// Travel History Generator — v47 (Fixed: Print Isolation)
// Changes:
// - FIX: Wrapped main app content in `print:hidden` so only the report prints.
// - FIX: Added print-specific resets to the Modal (remove scrollbars/shadows on print).
// - FEAT: Added `overflow-visible` to print container to ensure multi-page reports print fully.
...
export default function TravelHistoryGeneratorPage() {
  ...
  return (
    <main className="py-10 sm:py-14">
      {/* WRAP THE MAIN CONTENT IN A DIV THAT HIDES ON PRINT */}
  ...
  return (
    <Transition show={open} as={Fragment}>
      <Dialog as="div" className="relative z-[100]" onClose={onClose}>
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto print:overflow-visible print:inset-0">
          <div className="flex min-h-full items-end justify-center p-0 text-center sm:items-center sm:p-0 print:items-start print:min-h-0 print:h-full">
            <TransitionChild
              as={Fragment}
              enter="ease-out duration-300"
            ...
            >
              <DialogPanel 
                className="relative transform bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-4xl sm:rounded-lg h-[90vh] flex flex-col print:h-auto print:shadow-none print:w-full print:max-w-none print:m-0 print:absolute print:inset-0"
              >
                {/* Header (No Print) */}
